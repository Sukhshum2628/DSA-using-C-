...
int main()
{
    ...
    for (int x : a)//For each loop very easy and important for array data structure.
        ...
        //for each loop iterates through elements of array. Introduced in C++ 11
        cout<<x<<endl;
    cout<<endl;
    int b[6] ={1,3,5};//keeping the array incomplete to see what is the outcome result
    cout<<"Parallel initialized Int Array B : "<<endl;
    for(int y : b)//Show that for each loop will work according to size of array and not according to number of elements initialized in the array
        cout<<y<<endl;
    cout<<endl;

    float c[6] = {1.2,2.4,3.6,48.54,99.48,54.68};
    cout<<"Completely initialized float array C : "<<endl;
    for(float z : c)
        cout<<z<<endl;
    cout<<endl;

    float d[6] = {12.6,82.4,43.6,4.54,77.48,54.88};//no need to know the type of array
